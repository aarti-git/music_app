...
// Login \sign-in 
    ...
    menuBar.addEventListener("click",function(){
      ...
      function playNow($el){
        ...
        var songListLenght = songList.length -1;
        const data = $el.dataset
        const SongtrackId = data.trackId;
      //   if(SongtrackId == 0){
      //     songList[SongtrackId].firstElementChild.click();
      //   }
      //   const var audioTag = document.querySelector(".audio-position");
      ...
      //   if(SongtrackId)
        for(i=0; i<songList.length; i++){
             var songItem = songList[i];
             songItem.firstElementChild.click();
